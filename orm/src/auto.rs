//! This module contains the auto-generated code for the ORM. Do not edit this file directly besides to re-export the tables or regenerate the code
...
allow_tables_to_appear_in_same_query!(cannibanoid_screen, terpenoid_screen, test_results, users,);
